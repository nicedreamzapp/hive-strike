// ---------- update ----------
function update(){t++;if(shake>0)shake--;if(msgT>0)msgT--;bugChorus();if(P.lives===0&&!P.dead&&t%64===0)SFX.heartbeat();
