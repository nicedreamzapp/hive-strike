...
function spawnBoss(){const b=BOSSES[LV().boss];const BH=b.hp*DIFF.bossHp()*(1+loop*.7);boss={...b,hp:BH,max:BH,x:W/2,y:-80,t:0,ph:0,rage:0,seg:[]};bossAlive=true;enemies=[];bossIntro=110;shake=30;say(b.name+'  —  FIGHT!');rumble(1.6,.07);swell(55,1.6,'triangle',.06,.5);
