...
BUGS={
 ...
 "silverfish":"a silver teardrop-shaped silverfish with three tail bristles",
...
BOSSES={
 ...
 "boss9":"a huge menacing giant cave glowworm larva, segmented translucent body glowing electric blue, hanging sticky silk threads, glowing eyes",
