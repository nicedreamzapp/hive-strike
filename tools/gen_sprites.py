...
BUGS={
 ...
 "glowworm":"a glow worm larva, a long flat segmented dark beetle larva with small pale green light spots along its back, six short legs, on a plain pure white background, no glow, no aura, no light halo around it, no bloom",
 ...
 "scorpionfly":"a snow scorpionfly: a slender FLY with two pairs of long narrow clear wings held out, a long beak-like snout, six thin legs, and a small curled bulb at the tip of its abdomen, not a scorpion, no pincers, no claws",
...
BOSSES={
 ...
 "boss7":"a huge menacing desert scorpion king, one continuous body, its segmented stinger tail curled up over its back and clearly attached to the abdomen, two raised pincers attached at the front, eight legs, armored, glowing eyes, nothing floating apart from the body",
 ...
 "boss10":"a huge menacing ice weta cricket, pale steel-blue and slate-grey armor plates with dark grey edges and frost crystals, clearly darker than the white background, spiny legs, glowing orange eyes, high contrast",
 "boss11":"a giant Limulus polyphemus Atlantic horseshoe crab seen from directly above, its huge smooth brown domed horseshoe-shaped carapace covering the entire front like a shield, a small hinged triangular rear plate with tiny side spikes, one long straight rigid tail spine, all legs hidden underneath the shell, glowing eyes on top of the dome, NOT a scorpion, NO claws, NO pincers, NO raised tail",
 "boss12":"a huge menacing fire ant queen, dark red-black armored body, huge jaws, glowing orange eyes, a few tiny embers on its back, no fire, no flames, no glow behind it, no aura, just the ant on plain white",
